...
import { ArrowsRightLeftIcon, ChartBarIcon, FunnelIcon, PlayIcon, SparklesIcon, TrashIcon, ArrowDownTrayIcon } from "@heroicons/vue/24/outline";
...
const exportQueries = async () => {
    try {
        const queries = sourceItems.value.filter(
            (payload) => payload.request_id === timeStore.selected
        );

<template>
    <div
        class="select-none gap-1 flex py-1 dark:text-slate-200"
    ...
    >
        <button
            :class="{
                ...
                'active border border-slate-400 dark:border-slate-500': screen.screen_name === screenStore.screen && screens.length > 1,

<template>
    <div
        class="select-none gap-1 flex py-1 dark:text-primary-200"
    ...
    >
        <button
            :class="{
                ...
                'active border border-primary-400 dark:border-primary-500': screen.screen_name === screenStore.screen && screens.length > 1,

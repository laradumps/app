<template>
    <div class="flex relative left-[3px] mr-[15px]">
        <div
            ...
            class="px-3 w-[40%] overflow-y-none overflow-y-auto rounded-sm dark:bg-slate-900 text-slate-600 dark:text-slate-300 font-normal text-xs"
        >
        ...
        <div
            ...
            class="w-2/3 p-3 mb-4 flex justify-center items-center text-slate-500 font-light"
        >
        ...
        <div
            v-if="typeof payload.content !== 'undefined'"
            class="w-[60%] right-0 bg-slate-50 dark:bg-slate-800 p-3 align-middle items-start"
        >

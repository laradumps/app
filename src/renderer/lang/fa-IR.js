export default {
    ...
    installer: {
        ...
        php_project_path_info:
            'اگر پروژه شما در داخل یک کانتینر Docker اجرا می‌شود، باید مسیر پروژه را در رایانه خود مشخص کنید: به عنوان مثال: /Users/user_name/Sites/my-project.',
        choose_your_preferred_ide: 'ویرایشگر مورد نظر خود را انتخاب کنید',
        preferred_ide_info:
            'در این بخش می‌توانید تنظیم کنید که لارادامپس پرونده‌های پروژه شما را در کدام ویرایشگر باز کند.',

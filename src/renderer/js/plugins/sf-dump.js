...
module.exports = Sfdump = window.Sfdump || (function (doc) {
    ...
    const rxEsc = /([.*+?^${}()|\[\]\/\\])/g;
    const idRx = /\bsf-dump-\d+-ref[012]\w+\b/;
    ...
    return function (root, x) {
        ...
        const options = [];
        let elt = root.getElementsByTagName('A');
        let len = elt.length;
        let i = 0; let s; let h;
        let t = [];
        ...
        a('click', (a, e, c) => {
            if (/\bsf-dump-toggle\b/.test(a.className)) {
                ...
                if (!toggle(a, isCtrlKey(e))) {
                    const r = doc.getElementById(a.getAttribute('href').slice(1));
                    const s = r.previousSibling;
                    let f = r.parentNode;
                    let t = a.parentNode;
                    t.replaceChild(r, a);
                    f.replaceChild(a, s);
        ...
        <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1683 1331l-166 165q-19 19-45 19t-45-19L896 965l-531 531q-19 19-45 19t-45-19l-166-165q-19-19-19-45.5t19-45.5l742-741q19-19 45-19t45 19l742 741q19 19 19 45.5t-19 45.5z"\/><\/svg>
          ...
          <button type="button" class="sf-dump-search-input-next" tabindex="-1">
            ...
            addEventListener(root, 'keydown', (e) => {
                ...
                if ((e.keyCode === 114 && !isSearchActive) || (isCtrlKey(e) && e.keyCode === 70)) {
                /* F3 or CMD/CTRL + F */
                    if (e.keyCode === 70 && document.activeElement === searchInput) {
                        /*
                 ...
                 */
                    ...
                    if (e.keyCode === 27) {
                        ...
                        (isCtrlKey(e) && e.keyCode === 71) /* CMD/CTRL + G */
                || e.keyCode === 13 /* Enter */
                || e.keyCode === 114 /* F3 */
                    ) {
                        e.preventDefault();

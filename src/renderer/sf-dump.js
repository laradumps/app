    ...
    (function (doc) {
        ...
        return function (root, x) {
            ...
            if (doc.evaluate && Array.from && root.children.length > 1) {
                ...
                search.innerHTML = `
                <input type="text" class="input input-xs sf-dump-search-input block px-2 py-1.5 tracking-wider font-normal w-40 focus:outline-none focus:ring-1 focus:text-base1-700 dark:bg-base1-700 dark:text-base1-100 dark:placeholder-base1-400 rounded-md border border-gray-200 dark:!border-base1-500 focus:border-base1-300 focus:ring-base1-400 text-xs">

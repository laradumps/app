...
1. Download the Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v1.7.0/LaraDumps-Setup-1.7.0.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v1.7.0/LaraDumps-1.7.0-universal.dmg)

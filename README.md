...
<div align="center">
  <br />
    <!--LaraDumpsVersion-->
  <p align="center">
    <a href="https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-Setup-2.4.1.exe">
      <img src="./art/os/windows.png" height="60" alt="LaraDumps Windows App" />
    </a>
    <a href="https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1-universal.dmg">
      <img src="./art/os/macos.png" height="60" alt="LaraDumps MacOS App" />
    </a>
    <a href="https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1.AppImage">
...
1. Download the Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-Setup-2.4.1.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1-universal.dmg)
 | [Linux](https://github.com/laradumps/app/releases/download/v2.4.1/LaraDumps-2.4.1.AppImage)
<!--EndOfLaraDumpsVersion-->

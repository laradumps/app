...
1. Download the Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v2.1.0/LaraDumps-Setup-2.1.0.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v2.1.0/LaraDumps-2.1.0-universal.dmg)
 | [Linux](https://github.com/laradumps/app/releases/download/v2.1.0/LaraDumps-2.1.0.AppImage)
<!--EndOfLaraDumpsVersion-->

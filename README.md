...
1. Download the Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v1.6.1/LaraDumps-Setup-1.6.1.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v1.6.1/LaraDumps-1.6.1-universal.dmg)

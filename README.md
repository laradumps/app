...
1. Download the Desktop App here: [Windows](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-Setup-2.2.0.exe) | [MacOS](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-2.2.0-universal.dmg)
 | [Linux](https://github.com/laradumps/app/releases/download/v2.2.0/LaraDumps-2.2.0.AppImage)
<!--EndOfLaraDumpsVersion-->
